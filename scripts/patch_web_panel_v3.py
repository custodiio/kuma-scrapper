"""
Script Patch v3.1:
- Suporte duplo a rotas com e sem prefixo /scrapper (resolve "Not Found" no Nginx)
- Adiciona a Aba Exclusiva '👤 Perfis Douyin'
- Corrige todas as chaves JS ({{ e }}) para evitar falhas no f-string do Python
- Garante o salvamento das configurações no SQLite
"""
...
print("✅ Web panel v3.1 atualizado com suporte duplo a /scrapper nas rotas!")
